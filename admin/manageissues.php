...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/shubham/Tours-and-travels-in-php-master/admin/updateissue.php?iid=<?php echo ($result->id);?>');">View </a>
</td>
